		...
		<div class="container climate-wrapper">
			<div class="row">
				...
				<div class="climate-text">
					...
					<p>If you're already here and made it this far, take a few moments to look at this graphic from the popular webcomic series <a href="https://xkcd.com/"><b>xkcd</b></a>. They do an excellent job of providing the history of global temperature fluctuation, and also putting into perspective its impact. It's a start to understanding rapid climate change, and hopefully, everyone viewing it for the first time can learn a thing or two.</p>
					<br>
					<br>
					<img class="climate-img" src="https://imgs.xkcd.com/comics/earth_temperature_timeline.png">
					<p class="climate-bottom">"[After setting your car on fire] Listen, your car's temperature has changed before."</p>
				</div>
			</div>
		</div>
	</div>
